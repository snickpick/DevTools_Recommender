...
class DeveloperToolsPrompts: 
    ...
    Focus on actual products/tools that developers can use, not general concepts"""
    ...
    def tool_extraction_user(query: str, content: str) -> str:
        return f"""
                ...
                Extract a list of specific tool/service names mentioned in this content that are relevant.
    ...
    Pay special attention to programming languages, frameworks, APIs, SDKs, and do not hallucinate."""
    ...
    def tool_analysis_user(company_name: str, content: str) -> str:
        return f"""Company/Tool: {company_name}
                ...
                Analyze this content from a developer's perspective and provide:
                    ...
                    - language_support: List of programming languages explicitly supported (e.g., Python, Java, Rust, Pyhton, Go, Swift)
                    - integration_capabilities: List of tools/platforms it integrates with (e.g., GitHub, VSCode, Sublime Text, Vim, Neovim, Emacs)

                Focus on developer-relevant features like APIs. SDKs, language support, integrations.
                """

    # Recommendation prompts 
    RECOMMENDATION_SYSTEM = """You are a senior software engineer providing quick, concise tech recommendations. Keep responses brief and actionable - maximum 3-4 sentences total."""
